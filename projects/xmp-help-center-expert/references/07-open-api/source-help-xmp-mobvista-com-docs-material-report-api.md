---
title: "素材报表API"
source: https://help-xmp.mobvista.com/docs/material_report_api
category: 07-open-api
captured_at: 2026-05-12
status: distilled-source
source_hash: 8eeaf873c2a269b6
aliases: XMP, 素材报表
...
- No strong rule sentence was extracted; inspect the raw source before relying on this note.

## Use Cases

- Use when the user asks about 07 open api concepts related to 素材报表API.
...
- `references/09-patterns/xmp-support-scenarios.md`

## Source Trace

- Input URL: https://help-xmp.mobvista.com/docs/material_report_api
- Final URL: https://help-xmp.mobvista.com/docs/material_report_api
- Row ID: ``
